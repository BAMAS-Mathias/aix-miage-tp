...
public class GestionException {
    ...
    private void methode4() throws Exception4 {
        // Note : Dans l'image, la condition est bien "valeur == 1",
        // ce qui ressemble à une erreur de copier-coller (probablement voulu être == 4),
        // mais j'ai transcrit tel quel.
